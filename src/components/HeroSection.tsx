                        ...
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            >
                                <h1
                                    ...
                                    Transform Your Ideas into Reality with Guidesoft
                                </h1>

                                <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg">
                                    Leading IT solutions provider specializing in software development, app development, and digital transformation.
                                </p>
    ...
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-foreground border-b border-white/10 pb-3 text-sm font-medium">Empowering businesses with innovative IT solutions</div>
                <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium">50+</span>
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            <Link
                                ...
                                <div className="text-xl font-bold">Guidesoft.</div>
                            </Link>
                ...
                <div className="flex flex-col items-center md:flex-row">
                    ...
                    <div className="relative py-6 md:w-[calc(100%-11rem)]">
                        <InfiniteSlider
                            ...
                            gap={112}>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-foreground font-bold text-lg">Guidesoft</div>
                            </div>

                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-foreground font-bold text-lg">TechCorp</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-foreground font-bold text-lg">InnovateIT</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-foreground font-bold text-lg">DevSolutions</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-foreground font-bold text-lg">CodeMasters</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-foreground font-bold text-lg">AppWizards</div>
                            </div>
                        </InfiniteSlider>
