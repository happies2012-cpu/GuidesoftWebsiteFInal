...
const BookingAppSolutions = () => {
  ...
  const projects = [
    {
      title: "Booking App Platform",
      client: "Tech Solutions Inc.",
      category: "Booking App",
      description: "Comprehensive On-demand booking solutions with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Booking App Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade On-demand booking solutions serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="On-demand booking solutions"
      category="Booking App Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Booking App?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default BookingAppSolutions;
