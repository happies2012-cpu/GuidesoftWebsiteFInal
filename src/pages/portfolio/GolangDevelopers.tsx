...
const GolangDevelopers = () => {
  ...
  const projects = [
    {
      title: "Golang Development Platform",
      client: "Tech Solutions Inc.",
      category: "Golang Development",
      description: "Comprehensive Go programming solutions with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Golang Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Go programming solutions serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Go programming solutions"
      category="Golang Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Golang Development?"
