...
const HotelBookingEngine = () => {
  ...
  const projects = [
    {
      title: "Hotel Booking Engine Platform",
      client: "Tech Solutions Inc.",
      category: "Hotel Booking Engine",
      description: "Comprehensive Advanced hotel reservation systems with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Hotel Booking Engine Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Advanced hotel reservation systems serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Advanced hotel reservation systems"
      category="Hotel Booking Engine Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Hotel Booking Engine?"
