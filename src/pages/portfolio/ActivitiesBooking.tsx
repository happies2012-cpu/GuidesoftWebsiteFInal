...
const ActivitiesBooking = () => {
  ...
  const projects = [
    {
      ...
      category: "Activities Booking",
      description: "Comprehensive Tours and activities booking platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Activities Booking Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Tours and activities booking platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Tours and activities booking platforms"
      category="Activities Booking Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Activities Booking?"
