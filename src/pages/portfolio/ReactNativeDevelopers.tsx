...
const ReactNativeDevelopers = () => {
  ...
  const projects = [
    {
      title: "React Native Development Platform",
      client: "Tech Solutions Inc.",
      category: "React Native Development",
      description: "Comprehensive Cross-platform mobile apps with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise React Native Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Cross-platform mobile apps serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="React Native Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your React Native Development?"
