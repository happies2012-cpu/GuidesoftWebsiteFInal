...
const B2BTravelPortal = () => {
  ...
  const projects = [
    {
      title: "B2B Travel Portal Platform",
      client: "Tech Solutions Inc.",
      category: "B2B Travel Portal",
      description: "Comprehensive Business-to-business travel platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise B2B Travel Portal Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Business-to-business travel platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Business-to-business travel platforms"
      category="B2B Travel Portal Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your B2B Travel Portal?"
