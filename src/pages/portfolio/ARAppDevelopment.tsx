...
const ARAppDevelopment = () => {
  ...
  const projects = [
    {
      title: "AR App Development Platform",
      client: "Tech Solutions Inc.",
      category: "AR App Development",
      description: "Comprehensive Augmented reality applications with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise AR App Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Augmented reality applications serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Augmented reality applications"
      category="AR App Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your AR App Development?"
