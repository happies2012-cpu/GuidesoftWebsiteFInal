...
const AmadeusAPIIntegration = () => {
  ...
  const projects = [
    {
      title: "Amadeus API Integration Platform",
      client: "Tech Solutions Inc.",
      category: "Amadeus API Integration",
      description: "Comprehensive Amadeus GDS integration solutions with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Amadeus API Integration Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Amadeus GDS integration solutions serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Amadeus GDS integration solutions"
      category="Amadeus API Integration Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Amadeus API Integration?"
