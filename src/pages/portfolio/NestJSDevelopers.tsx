...
const NestJSDevelopers = () => {
  ...
  const projects = [
    {
      title: "NestJS Development Platform",
      client: "Tech Solutions Inc.",
      category: "NestJS Development",
      description: "Comprehensive Enterprise Node.js framework with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise NestJS Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Enterprise Node.js framework serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Enterprise Node.js framework"
      category="NestJS Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your NestJS Development?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default NestJSDevelopers;
