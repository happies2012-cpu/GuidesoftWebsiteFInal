...
const LaravelDevelopers = () => {
  ...
  const projects = [
    {
      title: "Laravel Development Platform",
      client: "Tech Solutions Inc.",
      category: "Laravel Development",
      description: "Comprehensive PHP framework development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Laravel Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade PHP framework development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="PHP framework development"
      category="Laravel Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Laravel Development?"
