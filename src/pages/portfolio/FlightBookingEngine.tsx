...
const FlightBookingEngine = () => {
  ...
  const projects = [
    {
      title: "Flight Booking Engine Platform",
      client: "Tech Solutions Inc.",
      category: "Flight Booking Engine",
      description: "Comprehensive Airline reservation systems with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Flight Booking Engine Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Airline reservation systems serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Airline reservation systems"
      category="Flight Booking Engine Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Flight Booking Engine?"
