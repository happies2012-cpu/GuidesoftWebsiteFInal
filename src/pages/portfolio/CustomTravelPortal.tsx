...
const CustomTravelPortal = () => {
  ...
  const projects = [
    {
      title: "Custom Travel Portal Platform",
      client: "Tech Solutions Inc.",
      category: "Custom Travel Portal",
      description: "Comprehensive Tailored travel solutions with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Custom Travel Portal Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Tailored travel solutions serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="Custom Travel Portal Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Custom Travel Portal?"
