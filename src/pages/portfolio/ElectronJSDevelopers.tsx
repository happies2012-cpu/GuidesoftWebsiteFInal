...
const ElectronJSDevelopers = () => {
  ...
  const projects = [
    {
      title: "Electron.js Development Platform",
      client: "Tech Solutions Inc.",
      category: "Electron.js Development",
      description: "Comprehensive Desktop application development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Electron.js Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Desktop application development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="Electron.js Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Electron.js Development?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default ElectronJSDevelopers;
