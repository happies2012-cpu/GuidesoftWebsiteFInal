...
const BusReservationSystem = () => {
  ...
  const projects = [
    {
      title: "Bus Reservation System Platform",
      client: "Tech Solutions Inc.",
      category: "Bus Reservation System",
      description: "Comprehensive Bus ticketing and reservation solutions with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Bus Reservation System Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Bus ticketing and reservation solutions serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Bus ticketing and reservation solutions"
      category="Bus Reservation System Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Bus Reservation System?"
