...
const HotelExtranet = () => {
  ...
  const projects = [
    {
      title: "Hotel Extranet Platform",
      client: "Tech Solutions Inc.",
      category: "Hotel Extranet",
      description: "Comprehensive Hotel management platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Hotel Extranet Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Hotel management platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Hotel management platforms"
      category="Hotel Extranet Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Hotel Extranet?"
