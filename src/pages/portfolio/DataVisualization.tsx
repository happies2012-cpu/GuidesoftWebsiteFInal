...
const DataVisualization = () => {
  ...
  const projects = [
    {
      ...
      description: "Comprehensive Data visualization platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Data Visualization Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Data visualization platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Data visualization platforms"
      category="Data Visualization Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Data Visualization?"
