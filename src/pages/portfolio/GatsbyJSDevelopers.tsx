...
const GatsbyJSDevelopers = () => {
  ...
  const projects = [
    {
      title: "Gatsby.js Development Platform",
      client: "Tech Solutions Inc.",
      category: "Gatsby.js Development",
      description: "Comprehensive Static site generation with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Gatsby.js Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Static site generation serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="Gatsby.js Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Gatsby.js Development?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default GatsbyJSDevelopers;
