...
const SwiftDevelopers = () => {
  ...
  const projects = [
    {
      title: "Swift Development Platform",
      client: "Tech Solutions Inc.",
      category: "Swift Development",
      description: "Comprehensive iOS Swift development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Swift Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade iOS Swift development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="iOS Swift development"
      category="Swift Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Swift Development?"
