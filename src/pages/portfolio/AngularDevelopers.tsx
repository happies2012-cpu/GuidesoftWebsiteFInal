...
const AngularDevelopers = () => {
  ...
  const projects = [
    {
      title: "Angular Development Platform",
      client: "Tech Solutions Inc.",
      category: "Angular Development",
      description: "Comprehensive Angular framework development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Angular Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Angular framework development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Angular framework development"
      category="Angular Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Angular Development?"
