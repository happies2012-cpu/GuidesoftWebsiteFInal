...
const DataEngineering = () => {
  ...
  const projects = [
    {
      ...
      description: "Comprehensive Big data solutions with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Data Engineering Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Big data solutions serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="Data Engineering Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Data Engineering?"
