...
const AndroidAppDevelopers = () => {
  ...
  const projects = [
    {
      title: "Android App Development Platform",
      client: "Tech Solutions Inc.",
      category: "Android App Development",
      description: "Comprehensive Native Android applications with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Android App Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Native Android applications serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="Android App Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Android App Development?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default AndroidAppDevelopers;
