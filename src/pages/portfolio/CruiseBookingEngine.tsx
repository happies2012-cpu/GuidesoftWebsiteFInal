...
const CruiseBookingEngine = () => {
  ...
  const projects = [
    {
      title: "Cruise Booking Engine Platform",
      client: "Tech Solutions Inc.",
      category: "Cruise Booking Engine",
      description: "Comprehensive Cruise reservation platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Cruise Booking Engine Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Cruise reservation platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Cruise reservation platforms"
      category="Cruise Booking Engine Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Cruise Booking Engine?"
