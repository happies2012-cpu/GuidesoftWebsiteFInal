...
const iOSDevelopers = () => {
  ...
  const projects = [
    {
      title: "iOS Development Platform",
      client: "Tech Solutions Inc.",
      category: "iOS Development",
      description: "Comprehensive Native iOS applications with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise iOS Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Native iOS applications serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="iOS Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your iOS Development?"
