...
const FoodDeliverySolutions = () => {
  ...
  const projects = [
    {
      title: "Food Delivery App Platform",
      client: "Tech Solutions Inc.",
      category: "Food Delivery App",
      description: "Comprehensive Food ordering and delivery platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Food Delivery App Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Food ordering and delivery platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Food ordering and delivery platforms"
      category="Food Delivery App Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Food Delivery App?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default FoodDeliverySolutions;
