...
const HTMLDevelopers = () => {
  ...
  const projects = [
    {
      title: "HTML/CSS Development Platform",
      client: "Tech Solutions Inc.",
      category: "HTML/CSS Development",
      description: "Comprehensive Frontend web development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise HTML/CSS Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Frontend web development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="HTML/CSS Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your HTML/CSS Development?"
