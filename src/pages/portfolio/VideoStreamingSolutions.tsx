...
const VideoStreamingSolutions = () => {
  ...
  const projects = [
    {
      ...
      description: "Comprehensive Video streaming platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Video Streaming Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Video streaming platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Video streaming platforms"
      category="Video Streaming Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Video Streaming?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default VideoStreamingSolutions;
