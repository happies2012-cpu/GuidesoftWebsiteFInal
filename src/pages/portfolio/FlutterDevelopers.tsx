...
const FlutterDevelopers = () => {
  ...
  const projects = [
    {
      title: "Flutter Development Platform",
      client: "Tech Solutions Inc.",
      category: "Flutter Development",
      description: "Comprehensive Flutter mobile development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Flutter Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Flutter mobile development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Flutter mobile development"
      category="Flutter Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Flutter Development?"
