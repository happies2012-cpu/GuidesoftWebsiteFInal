...
const ExpressJSDevelopers = () => {
  ...
  const projects = [
    {
      title: "Express.js Development Platform",
      client: "Tech Solutions Inc.",
      category: "Express.js Development",
      description: "Comprehensive Lightweight Node.js framework with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Express.js Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Lightweight Node.js framework serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Lightweight Node.js framework"
      category="Express.js Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Express.js Development?"
