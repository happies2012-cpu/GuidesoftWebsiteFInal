...
const VacationRentalManagement = () => {
  const stats = [
  ...
  const projects = [
    {
      title: "Vacation Rental Management Platform",
      client: "Tech Solutions Inc.",
      category: "Vacation Rental Management",
      description: "Comprehensive Property management systems with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Vacation Rental Management Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Property management systems serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Property management systems"
      category="Vacation Rental Management Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Vacation Rental Management?"
      ctaDescription="Let's create a custom solution that drives results and exceeds your expectations"
    />
  );
};

export default VacationRentalManagement;
