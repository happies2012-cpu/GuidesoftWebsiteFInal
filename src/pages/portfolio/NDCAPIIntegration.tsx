...
const NDCAPIIntegration = () => {
  ...
  const projects = [
    {
      title: "NDC API Integration Platform",
      client: "Tech Solutions Inc.",
      category: "NDC API Integration",
      description: "Comprehensive New Distribution Capability integration with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise NDC API Integration Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade New Distribution Capability integration serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="New Distribution Capability integration"
      category="NDC API Integration Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your NDC API Integration?"
