...
const B2CTravelPortal = () => {
  ...
  const projects = [
    {
      title: "B2C Travel Portal Platform",
      client: "Tech Solutions Inc.",
      category: "B2C Travel Portal",
      description: "Comprehensive Consumer travel booking platforms with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise B2C Travel Portal Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Consumer travel booking platforms serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Consumer travel booking platforms"
      category="B2C Travel Portal Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your B2C Travel Portal?"
