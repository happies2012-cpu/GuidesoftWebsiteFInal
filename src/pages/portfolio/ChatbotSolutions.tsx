...
const ChatbotSolutions = () => {
  ...
  const projects = [
    {
      title: "Chatbot Solutions Platform",
      client: "Tech Solutions Inc.",
      category: "Chatbot Solutions",
      description: "Comprehensive AI-powered chatbot development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Chatbot Solutions Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade AI-powered chatbot development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="AI-powered chatbot development"
      category="Chatbot Solutions Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Chatbot Solutions?"
