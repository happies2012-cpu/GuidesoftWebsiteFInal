...
const NextJSDevelopers = () => {
  ...
  const projects = [
    {
      title: "Next.js Development Platform",
      client: "Tech Solutions Inc.",
      category: "Next.js Development",
      description: "Comprehensive Next.js full-stack development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Next.js Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Next.js full-stack development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      subtitle="Next.js full-stack development"
      category="Next.js Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Next.js Development?"
