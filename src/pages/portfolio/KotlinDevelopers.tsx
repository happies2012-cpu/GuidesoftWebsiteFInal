...
const KotlinDevelopers = () => {
  ...
  const projects = [
    {
      title: "Kotlin Development Platform",
      client: "Tech Solutions Inc.",
      category: "Kotlin Development",
      description: "Comprehensive Modern Android development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise Kotlin Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade Modern Android development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="Kotlin Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your Kotlin Development?"
