...
const ReactJSDevelopers = () => {
  ...
  const projects = [
    {
      title: "React.js Development Platform",
      client: "Tech Solutions Inc.",
      category: "React.js Development",
      description: "Comprehensive React frontend development with advanced features and seamless user experience.",
    ...
    {
      title: "Enterprise React.js Development Solution",
      client: "Global Enterprises Ltd.",
      category: "Enterprise Solution",
      description: "Scalable enterprise-grade React frontend development serving millions of users worldwide.",
      image: getHeroImage('default'),
  ...
  return (
    <GenericPortfolioPage
      ...
      category="React.js Development Showcase"
      stats={stats}
      projects={projects}
      capabilities={capabilities}
      technologies={technologies}
      ctaTitle="Ready to Build Your React.js Development?"
