          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={containerVariants} className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Guidesoft excels in native mobile app development, crafting high-performance applications optimized for iOS and Android platforms. Experience the power of platform-specific technologies for unparalleled speed and functionality.
              </p>
            ...
            <motion.div variants={containerVariants} className="relative">
              <img
                src={getHeroImage('native-app')} // Replace with actual native app mockup image
