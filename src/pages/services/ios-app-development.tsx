          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={containerVariants} className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Guidesoft specializes in creating premium iOS applications using Swift and Apple's latest technologies. We deliver elegant, high-performance apps that delight users on iPhone, iPad, and beyond.
              </p>
            ...
            <motion.div variants={containerVariants} className="relative">
              <img
                src={getHeroImage('ios-app')} // Replace with actual iOS app mockup image
